<h1>Antillia Realistic AutoAnnotation Tool (Updated: 2023/02/22)</h1>
...
<a href="#14">14 CA_RoadSigns_78classes</a><br>
...
<li>
 Added a sample project <b>CA_RoadSigns_120classess</b> (2023/02/22).
...
<img src="./assets/jp_real_roadsigns_DSC04599.jpg" width="1024" height="auto">
<br>
...
You can download the following dataset created by the command above:
<pre>
COCO_US_RoadSigns_86classes.zip
TFRecord_US_RoadSigns_86classes.zip
realistic_test_dataset.zip
YOLO_US_RoadSigns_86classes.zip
</pre>
from here
...
You can download the following dataset created by the command above:
<pre>
COCO_UK_RoadSigns_94classes.zip
TFRecord_UK_RoadSigns_94classes.zip
realistic_test_dataset.zip
YOLO_UK_RoadSigns_94classes.zip
</pre>
from here
...
You can download the following dataset created by the command above:
<pre>
COCO_FR_RoadSigns_152classes.zip
TFRecord_FR_RoadSigns_152classes.zip
realistic_test_dataset.zip
YOLO_FR_RoadSigns_152classes.zip
</pre>
from here
...
The PNG files in DE_RoadSigns_108classes_Master have been take from the following websites:<br>
...
You can download the following dataset created by the command above:
<pre>
COCO_DE_RoadSigns_108classes.zip
TFRecord_DE_RoadSigns_108classes.zip
realistic_test_dataset.zip
YOLO_DE_RoadSigns_108classes.zip
</pre>
from here
<br>
<a href="https://drive.google.com/drive/folders/1Thgdl6EITQ7psZNI50ONS1A_jn40qQQO?usp=sharing">DE_RoadSigns_108classes_V7</a>
-->
...
<h2><a name="13">13 IT_RoadSigns_120classes (Updated: 2023/02/18)</a></h2>
...
<img src="./assets/IT_RoadSigns_120classes.png" width="720" height="auto"><br>
...
<br>
<h3><a name="13.2">13.2. Run create command</a> </h3>
Please run the following batch processing command to create YOLO, TFRecord and COCO dataset from your base image dataset at once, 
<pre>
./create.bat
</pre>
...
You can download the following dataset created by the command above:
<pre>
COCO_IT_RoadSigns_108classes.zip
TFRecord_IT_RoadSigns_108classes.zip
realistic_test_dataset.zip
YOLO_DE_RoadSigns_108classes.zip
</pre>
from here
...
<a href="https://drive.google.com/drive/folders/1Thgdl6EITQ7psZNI50ONS1A_jn40qQQO?usp=sharing">DE_RoadSigns_108classes_V7</a>
-->
See also:<a href="https://github.com/sarah-antillia/EfficientDet-Slightly-Realistic-IT-RoadSigns-120classes">EfficientDet-Slightly-Realistic-IT-RoadSigns-120classes</a>
<br>
Inference example of realistic_test_dataset generated by this tool:<br>
<img src="./assets/it_roadsigns_1003.jpg" width="1024" height="auto">



<h2><a name="14">14 CA_RoadSigns_78classes (Updated: 2023/02/22)</a></h2>
<h3><a name="14.1">14.1. Create CA_RoadSigns_78classes project</a></h3>
You can create <b>CA_RoadSigns_78classes</b> project by running the following command.
<pre>
python ProjectCreator.py roadsigns ca_roadsigns CA_RoadSigns_78classes
</pre>
<b>Sample images of PNG_CA_RoadSigns_78classes_Master</b><br>
<img src="./assets/CA_RoadSigns_78classes.png" width="720" height="auto"><br>

The PNG files in CA_RoadSigns_78classes_Master have been take from the following websites:<br>
<a href="https://en.wikipedia.org/wiki/Road_signs_in_Canada">Road signs in Canada</a>
<br>

<br>
<h3><a name="14.2">14.2. Run create command</a> </h3>
Please run the following batch processing command to create YOLO, TFRecord and COCO dataset from your base image dataset at once, 
<pre>
./create.bat
</pre>
...
<a href="https://drive.google.com/drive/folders/1Thgdl6EITQ7psZNI50ONS1A_jn40qQQO?usp=sharing">DE_RoadSigns_108classes_V7</a>
-->
See also:<a href="https://github.com/sarah-antillia/EfficientDet-Slightly-Realistic-CA-RoadSigns-78classes">EfficientDet-Slightly-Realistic-IT-RoadSigns-120classes</a>
<br>
Inference example of realistic_test_dataset generated by this tool:<br>
<img src="./assets/ca_roadsigns_1003.jpg" width="1024" height="auto">
